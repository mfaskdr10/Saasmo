...
export const HeroSection = () => {
  return (
    <section className="relative pt-30 pb-40 md:pb-50 md:pt-50 md:min-h-screen flex flex-col items-center md:justify-between gap-20 px-4 md:px-8 xl:px-18.75 xl:flex-row">
