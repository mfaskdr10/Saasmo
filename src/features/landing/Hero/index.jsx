...
export const HeroSection = () => {
  return (
    <section className="relative pb-20 md:h-screen md:pb-0 overflow-hidden">
      ...
      {/* Main Container */}
      <div className="flex flex-col justify-between gap-20 min-h-screen pt-35 md:pt-30 px-4 md:px-18.75 md:flex-row border">
        <HeroContent />
        <HeroVisuals />
      </div>
    </section>
